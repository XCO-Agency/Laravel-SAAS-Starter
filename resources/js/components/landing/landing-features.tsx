...
export function LandingFeatures() {
    ...
    const features = [
        ...
        },
        {
            ...
            description: t('landing.features.items.admin.description', 'Global dashboard to monitor workspaces, impersonate users, and oversee the entire SaaS platform.'),
            color: 'text-rose-500',
        ...
        },
        {
            ...
            description: t('landing.features.items.flags.description', 'Native Laravel Pennant integration to roll out features globally or target specific workspaces.'),
        ...
        },
        {
            ...
            description: t('landing.features.items.audit.description', 'Comprehensive activity tracking of system changes, property diffs, and administrative actions.'),
            color: 'text-teal-500',
            bgColor: 'bg-teal-500/10',
        },
        {
            icon: Megaphone,
            title: t('landing.features.items.announcements.title', 'Global Announcements'),
            description: t('landing.features.items.announcements.description', 'Schedule and broadcast custom, highly visible alert banners to all authenticated users.'),
