...
import { Plus, X, FileText, Type, Hash, Calendar, ToggleLeft, List, Link, AlignLeft, Trash2, GripVertical } from 'lucide-react';
...
export function CustomFieldsManager({ workspaceId, fields: initialFields, isAdmin }: CustomFieldsManagerProps) {
      ...
      <div className="flex items-start justify-between border-b border-slate-200 p-6 dark:border-slate-800">
        <div className="space-y-1">
          <div className="flex items-center gap-3">
            <FileText className="h-5 w-5 text-cyan-500" strokeWidth={2.5} />
        ...
        <form onSubmit={handleCreate} className="border-b border-slate-200 bg-slate-50 p-6 dark:border-slate-800 dark:bg-slate-900/50">
          <div className="space-y-6">
            <div className="grid gap-4 md:grid-cols-2">
              <div>
                <Label htmlFor="field-name" className="font-mono text-xs uppercase tracking-wide text-slate-500">
                  Field Name
                </Label>
                <Input
                  id="field-name"
            ...
            <div className="flex items-center gap-3">
              ...
              />
              <Label htmlFor="is-required" className="font-mono text-sm">
                Required field
              </Label>
            </div>
            ...
            <div className="flex justify-end gap-2 border-t border-slate-200 pt-4 dark:border-slate-700">
              ...
              <Button
                ...
                className="bg-cyan-500 font-mono text-xs uppercase tracking-wide hover:bg-cyan-600"
              >
      ...
      <div className="divide-y divide-slate-100">
        {fields.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="font-mono text-sm text-slate-500">No custom fields yet</p>
            ...
            >
              ...
              {isAdmin && (
                <button
                  ...
                  className="opacity-0 text-slate-400 transition-all hover:text-rose-500 group-hover:opacity-100"
                  title="Delete field"
                >
                  {deletingId === field.id ? (
