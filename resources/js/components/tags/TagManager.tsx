                    ...
                    <div className="grid gap-6 md:grid-cols-[1fr,auto] md:items-end">
                                    ...
                                    {PRESET_COLORS.map((color) => (
                                        <button
                                            ...
                                            className={`h-10 w-10 rounded-none border-2 transition-all ${
                                                newTag.color === color
                                                    ? 'scale-110 border-slate-900 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]'
                        ...
                        <div className="flex gap-2">
                            ...
                            <Button
                                ...
                                size="sm"
                                className="bg-rose-500 font-mono text-xs tracking-wide uppercase hover:bg-rose-600"
                            >
                            ...
                            >
                                ...
                                {isAdmin && (
                                    <button
                                        ...
                                        className="ml-1 text-slate-400 opacity-0 transition-all group-hover:opacity-100 hover:text-rose-500"
                                        title="Delete tag"
                                    >
                                        {deletingId === tag.id ? (
