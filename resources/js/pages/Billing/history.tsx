...
export default function BillingHistory({ invoices }: BillingHistoryProps) {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: t('billing.history.title', 'Invoice History'), href: '/billing/history' },
    ];
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <WorkspaceLayout
                ...
                description={t('billing.history.description', 'View and download all your invoices')}
                fullWidth
            >
                <div className="space-y-6">
                    ...
                    <div className="grid gap-4 md:grid-cols-3">
                        ...
                        <Card>
                            <CardHeader className="pb-2">
                                <CardDescription>Filtered Amount</CardDescription>
                        ...
                        <Card>
                            <CardHeader className="pb-2">
                                ...
                                <CardTitle className="text-lg">
                                    {invoices.length > 0 ? invoices[0].date : 'N/A'}
                                </CardTitle>
                            </CardHeader>
                        </Card>
                    </div>
                        ...
                        <CardContent className="pt-6">
                            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <Button
                                        variant={dateFilter === 'last90' ? 'default' : 'outline'}
                                        size="sm"
