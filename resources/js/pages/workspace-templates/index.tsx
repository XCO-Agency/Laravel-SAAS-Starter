...
export default function WorkspaceTemplatesIndex({
    templates,
    meta,
    categories,
    filters,
                    ...
                    <div className="container mx-auto px-6 py-12">
                        <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
                            <div className="space-y-2">
                                ...
                                <h1 className="font-mono text-4xl font-black tracking-tight text-slate-900 uppercase dark:text-white">
                                    Templates
                                </h1>
                                <p className="max-w-md font-mono text-sm text-slate-500">
                                    Create new workspaces from pre-configured
                                    templates. Save time, maintain consistency.
                                </p>
                            </div>

                            <Button
                                onClick={() =>
                                    router.visit('/workspace-templates/create')
                                }
                                className="border-2 border-slate-900 bg-violet-500 font-mono text-xs tracking-wide text-white uppercase shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] dark:border-slate-700"
                            >
                            ...
                            {Object.entries(categories).map(([key, label]) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`inline-flex items-center gap-2 border-2 px-4 py-2 font-mono text-xs tracking-wide uppercase transition-all ${
                                            isActive
                    ...
                    {templates.length === 0 ? (
                        <div className="flex flex-col items-center justify-center py-20 text-center">
                            ...
                            <p className="mt-2 max-w-sm font-mono text-sm text-slate-500">
                                Try adjusting your search or category filter, or
                                create a new template from your current
                                workspace.
                            </p>
                        </div>
                    ) : (
                                            ...
                                            <div className="p-6">
                                                ...
                                                <div className="flex items-start justify-between">
                                                    <div className="flex items-center gap-3">
                                                        <div
                                                            className={`flex h-10 w-10 items-center justify-center ${colorClass} text-white`}
                                                        >
                                                    ...
                                                    {template.is_public && (
                                                        <span className="border border-slate-200 px-2 py-0.5 font-mono text-[10px] tracking-wide text-slate-500 uppercase dark:border-slate-700">
                                                            Public
                                                        </span>
                                                    )}
                                                </div>
                                                ...
                                                <div className="mt-6 flex items-center justify-between border-t border-slate-100 pt-4 dark:border-slate-800">
                                                    ...
                                                    <div className="flex gap-2">
                                                        ...
                                                        <Button
                                                            ...
                                                            className="bg-slate-900 font-mono text-xs tracking-wide text-white uppercase hover:bg-slate-800"
                                                        >
                                                            Use
                                                        </Button>
                                                    </div>
